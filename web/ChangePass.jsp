    ...
    <div class="card">
        ...
        <div class="header pt-3 blue lighten-3">
            ...
            <div class="row d-flex justify-content-start">
                <h3 class="deep-grey-text mt-3 mb-4 pb-1 mx-5" style="font-family: sans-serif;">Change Password</h3>
            </div>
        ...
        <!--Header-->
            ...
            <div class="card-body mx-4 mt-4">
                 <form action="ChangePasswordAdmin" >
                ...
                <div class="text-center mb-4">
                    <button type="submit"  class="btn btn-unique btn-block z-depth-2 waves-effect waves-light">Change</button>
                </div>
