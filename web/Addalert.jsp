    ...
    <div class="card">
        ...
        <div class="header pt-3 blue lighten-3">
            ...
            <div class="row d-flex justify-content-start">
                <h3 class="deep-grey-text mt-3 mb-4 pb-1 mx-5" style="font-family: sans-serif;">New Alert</h3>
            </div>

        </div>
<form action="AddAlert" style="background-color: white; padding:100px 100px 100px 100px;">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="md-form">
    <input type="number" name="size" id="form1" class="form-control" required>
...
<!--    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="md-form">
                <input type="text" name="type" id="form41" class="form-control" required>
