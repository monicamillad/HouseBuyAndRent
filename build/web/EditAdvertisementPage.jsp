    ...
    <div class="card">
        ...
        <div class="header pt-3 blue lighten-3">
            ...
            <div class="row d-flex justify-content-start">
                <h3 class="deep-grey-text mt-3 mb-4 pb-1 mx-5" style="font-family: sans-serif;">Edit Advertisement</h3>
            </div>
...
%>
<form action="EditAdvertisment" style="background-color: white; padding:100px 100px 100px 100px;" >
    ...
    <input type="text" name="title1" id="form1" value="<%= title %>" class="form-control" disabled="disabled">
    <input type="text" name="title" id="form1" value="<%= title %>" class="form-control" hidden="">
    <label for="form1" class="">Title</label>
    
      <!--  <lable class="card-title">Title <%= title %></h3> --> 
        ...
        <div class="col-md-5">
            <div class="md-form">
               <input type="text" name="size" id="form1" value="<%=size %>" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="md-form">
                <input type="text" name="type" id="form41" value="<%=type %>" class="form-control">
		...
		<div class="col-md-4">
            <div class="md-form">
               <input type="text" name="floor" id="form1" value="<%=floor %>" class="form-control">
       ...
       <div class="col-md-4" >
            <div class="md-form">
                <input type="text" name="status" id="form41" value="<%=status %>" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="md-form">
                <input type="text" name="description" id="form76" value="<%=description %>" class="form-control"/>
    ...
    <div class="row">
         ...
         <%
         	...
         	{
         		%>
         		<label class="radio"><input id="radio" type="radio" value="sell" name="radios" checked><span class="outer"><span class="inner"></span></span>Sell</label>
			    <label class="radio"><input id="radio1" type="radio" value="rent" name="radios" ><span class="outer"><span class="inner"></span></span>Rent</label>	
         		<%
         	}
         	else
         	{
		        ...
		        <label class="radio"><input id="radio1" type="radio" value="rent" name="radios" checked><span class="outer"><span class="inner"></span></span>Rent</label>
         		<%
         	}
         %>
		   </div>
        <!--  
         <div class="col-md-6" style="margin-left: 20px;">
            <span class="btn btn-default btn-file btn-block z-depth-2 waves-effect waves-light">
  				  Pictures <input type="file" name="pics" id="pics" accept=".jpg, .jpeg, .png" multiple="multiple"/>
			</span>
        </div>
        -->
        </div>
     ...
     <div class="text-center mb-4">
                <button type="submit" onclick="getMarkerPosition()" class="btn btn-unique btn-block z-depth-2 waves-effect waves-light">Edit</button>
            </div>
