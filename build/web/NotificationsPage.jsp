...
<% 
    ...
    String q = "SELECT * FROM notification where username='"+uname+"' ;" ;
    ...
    while( res.next() ){
        ...
        String t = "ViewAdvertisment?title=" + res.getString("link") ;
%>
        ...
        <div class="card-body">
                ...
                <a class="btn btn btn-secondary" href=<%=t%> >View</a>
                <!--<button type="button" class="btn btn btn-secondary" onclick= >View</button>-->
